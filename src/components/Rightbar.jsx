...
export default function Rightbar() {
  return (
    ...
    >
      <Box position="fixed">
        <Typography variant="h6" fontWeight={100} text="center" mb="{2}">
          Online Friends
        </Typography>
        <AvatarGroup max={4}>
        ...
        <ImageList cols={3} rowHeight={100} gap={5}>
          ...
          <ImageListItem sx={{ height: "100" }}>
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBkl9nu5Z5plHw7F8U3ytSs_7aw5aEAEQbAg&usqp=CAU"
              alt=""
              loading="lazy"
            />
          </ImageListItem>
        ...
        <Typography variant="h6" fontWeight={100} text="center" mt={2} mb={2}>
          Conversation
        </Typography>
        <List
